...
if filter_dir == 1:
    print()
    if filter_list == 1:
        print("All kanji in Sheet1 which have a score at or above the threshold in the English to Japanese list will be filtered to Sheet2.")
    elif filter_list == 2:
        print("All kanji in Sheet1 which have a score at or above the threshold in the Japanese to English list will be filtered to Sheet2.")
    print()
    while True:
        try:
    ...
    print()
    if filter_list == 1:
        print("All kanji in Sheet2 which have a score at or below the threshold in the English to Japanese list will be filtered to Sheet1.")
    elif filter_list == 2:
        print("All kanji in Sheet2 which have a score at or below the threshold in the Japanese to English list will be filtered to Sheet1.")
    print()
    while True:
        try:
            filter_thresh = int(input("what do you want the threshold to be? (whole number please):"))
